  ...
  return new Promise((resolve, reject) => {
    ...
    function get(u, redirects = 0) {
      ...
      const req = https.get({
        ...
        headers: {
          'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AVINStudioBot/7.0',
...
const items = [
  // 1. Traditional Seemantha (Bangle Wearing Ceremony)
  {
    name: 'seemantha_bangles.jpg',
    url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/27/Bangle_wearing_ceremony.jpg/1280px-Bangle_wearing_ceremony.jpg'
  },
  // 2. Beautiful Indian wedding couple in Mandap
  {
    name: 'wedding_mandap_couple.jpg',
